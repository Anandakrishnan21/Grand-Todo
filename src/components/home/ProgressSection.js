...
function ProgressSection({ todo }) {
  return (
    <div className="w-full md:w-1/2 h-full md:h-60 flex flex-col bg-white border-[1px] border-[#dbdbdb] shadow-sm rounded-md p-4">
      ...
      <div className="flex flex-col-reverse md:flex-row justify-center items-center text-sm md:text-base">
        <div className="w-full flex flex-col text-sm gap-2">
          ...
          <Link href="/today" className="w-1/2 border text-sm bg-blue-50 text-blue-600 p-1 rounded-md">
            Complete your task
          </Link>
        </div>
